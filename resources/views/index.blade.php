      ...
      <div class="content">
        ...
        <div class="wrap reverse">
            <div class="wd-3 mwd-12">
                ...
                <p>Простой калькулятор ремонта квартиры — это инструмент, созданый профессионалами для людей, которые хотят сделать ремонт, не вдаваясь в тонкости и детали процесса.</p>
                @endcomponent
            </div>
