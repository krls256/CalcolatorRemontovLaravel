                  ...
                  <span>
                    ...
                    @endphp
                                ...
                                @if($val->provider === 'yell')
                                    <a href="https://yell.ru/{{ $yell_id }}/?reviewId={{ $val->review_id }}"
                                       class="link-button" target="_blank">К источнику</a>
                                @elseif ($val->provider === 'flamp')
                                    <a href="https://flamp.ru/firm/reviews-{{ $flamp_id }}/otzyv-{{ $val->review_id }}"
                                       class="link-button" target="_blank">К источнику</a>
                                @elseif ($val->provider === 'yandex')
                                    <a href="https://yandex.ru/maps/org/{{ $yandex_id }}" class="link-button"
                                       target="_blank">К источнику</a>
                                @endif

                                @if( Auth::check() )
                                    <a href="#" data-id="{{ $val->id }}" class="link-button red reviews-delete"
                ...
                <div class="wd-4 mwd-12">
                    <div class="boxes company-info">
                        ...
                        <div class="company-info__footer">
                            ...
                            <a href="#animatedModal" class="button__blue send-zamer" data-id="{{ $id }}">Оставить
                                заявку</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="wd-12 mwd-12">
                        <div class="page-nav">
                            @if ( $reviewsNav['сurrent'] > 1 )
                                ...
                                <a href="/rating/{{ $url }}/{!! $reviewsNav['сurrent']-1 !!}"
                                   class="page-nav__back"></a>
                            @endif
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="close-animatedModal">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 340.8 340.8">
                        <path
