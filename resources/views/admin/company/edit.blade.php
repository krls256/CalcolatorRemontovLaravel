      ...
      <div class="row padding">
        ...
        <div class="col-6">
          ...
          <label for="phone" class="input">
            <input type="text" id="phone" name="phone" placeholder="+7 (___) ___-__-__" value="{{ $phone ?? '' }}">
          </label>
        </div>
      </div>
      <div class="row padding">
        <div class="col-6">
          ...
          <label for="data" class="input">
            <input type="text" id="data" name="data" placeholder="01.01.1970" class="create_company" autocomplete="off" data-date="{{ $date ?? '' }}" value="{{ $date ?? '' }}"/>
          </label>
        </div>
        <div class="col-6">
          <div class="input__title">Адрес компании</div>
          <label for="address" class="input">
            <input type="text" id="address" name="address" placeholder="ул. Ленина, д. 1" value="{{ $address ?? '' }}"/>
          </label>
        </div>
      </div>
      <div class="row padding">
      ...
      <div class="row padding">
        <div class="col-6">
          ...
          <label for="redecorating" class="input">
            <input type="text" id="redecorating" name="redecorating" placeholder="Цена за 1 м²" autocomplete="off" value="{{ $redecorating }}"/>
            <span>руб.</span>
          </label>
        </div>
        <div class="col-6">
          ...
          <label for="overhaul" class="input">
            <input type="text" id="overhaul" name="overhaul" placeholder="Цена за 1 м²" autocomplete="off" value="{{ $overhaul }}"/>
            <span>руб.</span>
          </label>
        </div>
      </div>
      <div class="row padding">
        <div class="col-6">
          ...
          <label for="turnkey_repair" class="input">
            <input type="text" id="turnkey_repair" name="turnkey_repair" placeholder="Цена за 1 м²" autocomplete="off" value="{{ $turnkey_repair }}"/>
            <span>руб.</span>
          </label>
        </div>
      </div>
      ...
      <div class="row padding">
        <div class="col-6">
          ...
          <label for="youtube" class="input">
            <input type="text" id="youtube" name="youtube" placeholder="https://" value="{{ $youtube ?? '' }}"/>
          </label>
        </div>
        <div class="col-6">
          <div class="input__title">YELL ID</div>
          <label for="yell" class="input">
            <input type="text" id="yell" name="yell" placeholder="ID на площадке YELL" value="{{ $yell_id ?? '' }}"/>
          </label>
        </div>
      </div>
      <div class="row padding">
        <div class="col-6">
          ...
          <label for="flamp" class="input">
            <input type="text" id="flamp" name="flamp" placeholder="ID на площадке FLAMP" value="{{ $flamp_id ?? '' }}"/>
          </label>
        </div>
        <div class="col-6">
          <div class="input__title">Yandex ShopID</div>
          <label for="yandex" class="input">
            <input type="text" id="yandex" name="yandex" placeholder="ID компании в yandex картах" value="{{ $yandex_id ?? '' }}"/>
          </label>
        </div>
      </div>
      <div class="row padding">
