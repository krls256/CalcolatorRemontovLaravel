...
class EstimatesController extends Controller
{
    ...
    public function addEstimates(Request $req)
    {
        ...
        $companyName = DB::table('company')
            ->where('id', $req->company)
            ->first();
        $create = DB::table('estimates')
            ->insertGetId([
    ...
    {
        $name = DB::table('estimates')
            ->where('id', $id)
            ->first();
        $db = DB::table('estimatesMeta')
    ...
    public function add() {
        $companies = DB::table('company')
            ...
            ->get();
        return view('admin.estimates.add', ['companies' => $companies]);
    }
}
